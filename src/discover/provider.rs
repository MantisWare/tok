...
/// Use `tok gain` to track savings for Cursor sessions instead.
...
mod tests {
    ...
    fn test_match_project_filter() {
        let encoded = ClaudeProvider::encode_project_path("/Users/foo/Sites/tok");
        assert!(encoded.contains("tok"));

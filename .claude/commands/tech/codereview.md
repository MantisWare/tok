---
model: sonnet
description: TOK Code Review — Review locale pre-PR avec auto-fix
---

# TOK Code Review

Review locale de la branche courante avant création de PR. Applique les critères de qualité TOK.
...
- Output format inconsistant avec les autres filtres TOK
...
- `lazy_static!` avec `unwrap()` pour initialisation → pattern établi TOK

# TOK Maintainers Application

TOK is growing fast, with more contributors, PRs, and ideas than ever. To keep things moving smoothly, we're looking for new maintainers.
...
- 3+ merged PRs to TOK (filters, fixes, docs — all contributions count)
...
2. In your application, include:
   ...
   - Your PRs that have been accepted in TOK
...
- A review of your ecosystem experience and understanding of TOK concepts
...
- Maintain consistency with the rest of the TOK ecosystem
...
Core Maintainers are responsible for the core of TOK. They have a broader scope and higher responsibilities and permissions, including:
...
If you enjoy contributing and want to help TOK scale in a healthy way, we'd be excited to have you onboard 🚀
